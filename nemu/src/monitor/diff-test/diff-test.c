...
void difftest_step(uint32_t eip) {
  ...
  if( (r.eax != cpu.eax ) || (r.ecx != cpu.ecx ) || (r.edx != cpu.edx ) || (r.ebx != cpu.ebx ) || (r.esp != cpu.esp ) || (r.ebp != cpu.ebp ) || (r.esi != cpu.esi ) || (r.esi != cpu.esi ) || (r.eip != cpu.eip ) )//比较两者的值是否相等，不同就设置为true
  {
	  diff = true;
